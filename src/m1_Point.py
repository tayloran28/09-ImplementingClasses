...
class Point(object):
    ...
    def move_to(self, x, y):
        dist = self.distance_from(Point(x, y))
        self.dist_traveled = self.dist_traveled + dist
    ...
    def move_by(self, dx, dy):
        dist = self.distance_from(Point(self.x + dx, self.y + dy))
        self.dist_traveled = self.dist_traveled + dist
    ...
    def get_distance_from_start(self):
        return self.distance_from(Point(self.start_x, self.start_y))
